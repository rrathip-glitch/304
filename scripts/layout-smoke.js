...
assert(/v=2\.2\.16/.test(html), 'index.html uses semver cache-bust marker (v2.2.16)');
...
assert(
  /BUILD\s*=\s*'2\.2\.16'/.test(client),
  'client.js declares BUILD = "2.2.16" (semver, not codename)',
);
assert(
