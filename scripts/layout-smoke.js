...
assert(/v=2\.2\.26/.test(html), 'index.html uses semver cache-bust marker (v2.2.26)');
...
assert(
  /BUILD\s*=\s*'2\.2\.26'/.test(client),
  'client.js declares BUILD = "2.2.26" (semver, not codename)',
);
assert(
