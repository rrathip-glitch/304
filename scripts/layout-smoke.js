...
assert(/v=2\.2\.13/.test(html), 'index.html uses semver cache-bust marker (v2.2.13)');
...
assert(
  /BUILD\s*=\s*'2\.2\.13'/.test(client),
  'client.js declares BUILD = "2.2.13" (semver, not codename)',
);
assert(
